...
from models.koElectra import train_electra_ensemble, build_meta_model_koElectra
#-----
# 0. test
#-----
...
meta_model_koElectra.fit(meta_train_koElectra, elec_train_y, validation_data=(meta_val_koElectra, elec_val_y),epochs=15,batch_size=64,callbacks=callbacks)
